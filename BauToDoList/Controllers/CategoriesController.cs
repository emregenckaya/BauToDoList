...
namespace BauToDoList.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate")] Category category)
        {
            if (ModelState.IsValid)
            {
                category.UpdatedDate = DateTime.Now;
        ...
        {
            StringWriter sw = new StringWriter();
            sw.WriteLine("Kategori Adı,Oluşturma Tarihi,Oluşturan Kullanıcı,Güncelleme Tarihi,Güncelleyen Kullanıcı");
